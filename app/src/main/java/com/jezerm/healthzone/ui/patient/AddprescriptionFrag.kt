...
class AddprescriptionFrag : DialogFragment() {
    ...
    override fun onCreateView(
        ...
        val view: View = inflater.inflate(R.layout.add_button_prescription, container, false)
    ...
    companion object {
        ...
        fun display(fragmentManager: FragmentManager?): AddprescriptionFrag {
            val exampleDialog = AddprescriptionFrag()
